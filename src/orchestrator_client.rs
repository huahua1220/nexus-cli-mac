...
impl OrchestratorClient {
        ...
        U: Message + Default,
    {
        ...
        if !friendly_messages.status().is_success() {
            ...
            let friendly_message = match status.as_u16() {
                ...
                429 => return Err(format!("RATE_LIMITED:[429] Too many requests. Please try again later.").into()),
    ...
    pub async fn get_tasks_batch(&self, node_id: &str) -> Result<Vec<crate::task::Task>, String> {
